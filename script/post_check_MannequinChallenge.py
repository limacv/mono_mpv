...
def main(istrain=True, check_black_list=False):
    trainset = MannequinChallenge_Img(istrain, black_list=False)
    ...
    file_path_tmp = os.path.join(MannequinChallenge_root, f"{trainset.trainstr}_valid.new.txt")
    ...
    if check_black_list:
        ...
        black_list_oldfile = os.path.join(MannequinChallenge_root, "black_list.txt")
        ...
        black_list_newfile = os.path.join(MannequinChallenge_root, "black_list.new.txt")

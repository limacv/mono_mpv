...
class RDN(nn.Module):
    def __init__(self, in_chnl=3, out_chnl=6, num_features=64, growth_rate=64, num_blocks=16, num_layers=8):
        ...
        self.output = nn.Conv2d(self.G0, out_chnl, kernel_size=3, padding=3 // 2)
